...
[题目0018](https://leetcode-cn.com/problems/remove-nth-node-from-end-of-list)甚简单，不知为何是*中等*题。<br>
...
后来回宿舍吼闲得无聊，又用python实现了[题目0018](https://leetcode-cn.com/problems/remove-nth-node-from-end-of-list)的原始任务以及*进阶*任务。